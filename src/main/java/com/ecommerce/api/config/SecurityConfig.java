    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .exceptionHandling(ex -> ex
                        // Manejar excepciones por no estar autenticado y querer acceder a endpoints protegidos (no logueado o JWT invalido/expirado)
                        .authenticationEntryPoint((request, response, authException) -> {
                            // Utilizar 401 en lugar del 403 por defecto
